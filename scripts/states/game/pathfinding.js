MY.Pathfinding = {
	diagonalSuccessors: function ($N, $S, $E, $W, N, S, E, W, grid, rows, cols, result, i) {
		if ($N) {
	...
	diagonalSuccessorsFree: function ($N, $S, $E, $W, N, S, E, W, grid, rows, cols, result, i) {
		$N = N > -1;
		$S = S < rows;
		$E = E < cols;
		$W = W > -1;
	...
	nothingToDo: function ($N, $S, $E, $W, N, S, E, W, grid, rows, cols, result, i) {
		return result;
	},
